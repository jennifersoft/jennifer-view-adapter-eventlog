...
public class LogConfig {
	...
	static final String PATTERN = "[%time] domain=%domainName(id=%domainId, group=%domainGroupHierarchy), instance=%instanceName(%instanceId), business=%businessName, level=%eventLevel, name=%eventName, value=%value";
